      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {studentAchievements.map((student) => (
            <div key={student.id} className="bg-indigo-50/80 dark:bg-gray-700 dark:hover:bg-gray-650 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="mt-4 p-4 bg-white/50 dark:bg-gray-600 rounded-lg">
